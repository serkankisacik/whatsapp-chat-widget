...
function serra_whatsapp_chat_widget_output() {
    ...
    $widget_position = esc_attr(get_option('serra_whatsapp_widget_position', 'right'));
    ob_start();
    ?>
    <style>
        #serra-whatsapp-chat {
    ...
    <div id='serra-whatsapp-chat' class='serra-hide'>
        <div class='serra-header-chat'>
            <div class='serra-head-home'>
                ...
                <p><span class="serra-whatsapp-name"><?php echo $site_title;?></span><br><small>Genellikle bir saat içinde yanıt verir</small></p>
            </div>
        ...
        <div class='serra-start-chat'>
            <div pattern="https://elfsight.com/assets/chats/patterns/whatsapp.png" class="WhatsappChat__Component-sc-1wqac52-0 serra-whatsapp-chat-body">
                <div class="WhatsappChat__MessageContainer-sc-1wqac52-1 serra-dAbFpq">
                    ...
                    <div style="opacity: 1;" class="WhatsappChat__Message-sc-1wqac52-4 serra-kAZgZq">
                        ...
                        <div class="WhatsappChat__Text-sc-1wqac52-2 serra-iSpIQi">Merhaba 👋<br><br>Size nasıl yardım edebilirim?</div>
                    </div>
                </div>
            </div>
